...
export async function sendVerificationEmail(
  ...
  const payload: BrevoEmailPayload = {
    ...
    to: [{ email }],
    subject: "🔐 Verify Your CBET Account",
...
<head>
    ...
    <title>Verify Your CBET Account</title>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p class="message">
                You're just one step away from accessing your CBET account!
            ...
            <div class="security-warning">
                ...
                <p class="warning-text">
                    Never share this code with anyone. CBET will never ask for your
            ...
            <div class="steps">
                ...
                <div class="step">
                    ...
                    <div class="step-description">Start using CBET immediately</div>
                </div>
            </div>
            ...
            <div class="signature">
                <div class="signature-name">The CBET Team</div>
        ...
        <div class="footer">
            ...
            <div class="copyright">
                © ${currentYear} CBET. All rights reserved.<br>
                CBET, Rongo University Headquarters
            </div>
        </div>
    </div>
</body>
